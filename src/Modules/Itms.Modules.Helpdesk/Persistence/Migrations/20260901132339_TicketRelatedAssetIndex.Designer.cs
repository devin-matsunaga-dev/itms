...
namespace Itms.Modules.Helpdesk.Persistence.Migrations
{
    ...
    [Migration("20260901132339_TicketRelatedAssetIndex")]
    partial class TicketRelatedAssetIndex
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Itms.Modules.Helpdesk.Domain.Ticket", b =>
                {
                    ...
                    b.Property<int>("ResolutionTargetMinutes")
                        ...
                        .HasColumnName("sla_resolution_target_minutes");

                    b.Property<DateTimeOffset>("ResolutionWarnAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("sla_resolution_warn_at");
                    ...
                    b.Property<DateTimeOffset?>("RespondedAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("sla_responded_at");
                    ...
                    b.Property<int>("ResponseTargetMinutes")
                        .HasColumnType("integer")
                        .HasColumnName("sla_response_target_minutes");

                    b.Property<DateTimeOffset>("ResponseWarnAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("sla_response_warn_at");
                    ...
                    b.Property<TimeSpan>("SlaPausedTotal")
                        ...
                        .HasColumnName("sla_paused_total");
                    ...
                    b.HasIndex("Status", "DueAt")
                        .HasDatabaseName("ix_tickets_status_due_at");

                    b.ToTable("tickets", "helpdesk");
                });

            modelBuilder.Entity("Itms.Modules.Helpdesk.Domain.TicketAttachment", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Itms.Modules.Helpdesk.Domain.TicketComment", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
