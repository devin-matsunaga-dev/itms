...
/// </remarks>
internal static class TicketCategoryUniqueness
{
    /// <summary>Looks for an existing category with the same normalised name.</summary>
    ...
    {
        var clash = await database.TicketCategories
            .AsNoTracking()
        ...
        return clash is null ? null : HelpdeskErrors.DuplicateCategoryName(clash);
    }
}
