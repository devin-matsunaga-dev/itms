...
/// <summary>
/// The trimming and length rules this module's entities apply to the text they are
/// handed.
/// </summary>
/// <remarks>
/// <para>
...
/// </para>
/// <para>
/// <b>This is the second named copy</b>, after <c>Itms.Modules.Helpdesk.Domain.ReferenceText</c>;
/// Directory inlines the same rules in its entities. A module may not reference another
/// module, so the duplication is forced until somebody hoists it — and the precedent this
/// repository set with <c>SearchPattern</c> is that the <em>third</em> copy is when it moves
/// to <c>Itms.Platform</c> rather than being written again.
/// </para>
/// </remarks>
